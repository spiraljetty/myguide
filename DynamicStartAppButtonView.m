                ...
                fontsize:(int)fontSize
{
    ...
    if (self) {
        ...
        demoButton.titleLabel.font = [UIFont boldSystemFontOfSize:fontSize];
...
//        [demoButton setTitle:@"  DEMO \nBUTTON" forState:UIControlStateNormal];
        ...
        switch (aType) {
            ...
            case kPopRectOrange:
                demoButton.frame = CGRectMake(10, 10, 199, 51);
                [demoButton setBackgroundImage:[UIImage imageNamed:@"demoButton5.png"] forState:UIControlStateNormal];
                break;
            ...
            case kPopRectDarkBlueLarge:
                ...
                break;
            case kPopRectOrangeLarge:
                demoButton.frame = CGRectMake(10, 10, 400, 102);
                [demoButton setBackgroundImage:[UIImage imageNamed:@"demoButton5@2x.png"] forState:UIControlStateNormal];
                break;
            default:
                break;
        }
