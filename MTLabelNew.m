...
+(id)label {
    ...
    return [[[MTLabelNew alloc] init] autorelease];

}

+(id)labelWithFrame:(CGRect)frame andText:(NSString *)text {
    
    return [[[MTLabelNew alloc] initWithFrame:frame andText:text] autorelease];
...
+(id)labelWithText:(NSString *)text {
    ...
    return [[[MTLabelNew alloc] initWithText:text] autorelease];
