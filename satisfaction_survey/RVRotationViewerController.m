...
-(id)initWithImageDirectory:(NSString *)directoryName
{
...
- (void)viewDidLoad
{
    ...
    rotationView = [[RVRotationView alloc] initWithFrame:CGRectMake(0, 0, 800, 600)];
    ...
    rotateLeftButton.frame = CGRectMake(5, 20, 50, 40);
    ...
    startButton.frame = CGRectMake(60, 20, 50, 40);
    ...
    stopButton.frame = CGRectMake(115, 20, 50, 40);
    ...
    rotateRightButton.frame = CGRectMake(170, 20, 50, 40);
    [self.view addSubview:rotateRightButton];
    
//    UILabel *decLabel = [[UILabel alloc] initWithFrame:CGRectMake(220, 40, 60, 13)];
