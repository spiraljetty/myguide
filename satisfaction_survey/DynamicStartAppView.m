                ...
                showInstitutionImage:(BOOL)shouldShowInstitutionImage
{
    ...
    if (self) {
        ...
        DynamicStartAppButtonView *startAppButtonView = [[DynamicStartAppButtonView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, 102) type:kPopRectGreenLarge text:@"START" target:aTarget selector:aSelector];
