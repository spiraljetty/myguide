...
- (void)viewDidLoad {
    ...
    [super viewDidLoad];
        AppDelegate_Pad *appDelegate=(AppDelegate_Pad *)[AppDelegate_Pad sharedAppDelegate];
	NSString *currentAppVersion = @"App Version: 9/18/14";//appDelegate.loaderViewController.currentWRViewController.appVersion ; //[[[[AppDelegate_Pad sharedAppDelegate] loaderViewController] currentWRViewController] appVersion];
